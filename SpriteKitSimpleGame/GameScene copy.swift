...
//        let monster2 = SKSpriteNode(imageNamed: "monster")
//        monster2.xScale = fabs(monster2.xScale) * -1.0
        ...
        let actualY = random(min: size.width * 0.1, max: size.width - monster.size.width/2)
